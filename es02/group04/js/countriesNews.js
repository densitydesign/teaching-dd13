...
$("#canadaswitch").click(function() {
    $("#canadaswitch rect").toggleClass("switchino");
    // $("#kenyaswitch").toggleClass("switchino");
    // $("#brazilswitch").toggleClass("switchino");
    // $("#namibiaswitch").toggleClass("switchino");
...
$("#kenyaswitch").click(function() {
  ...
  // $("#canadaswitch").toggleClass("switchino");
  // $("#brazilswitch").toggleClass("switchino");
  // $("#namibiaswitch").toggleClass("switchino");
        $("#Canada").hide();
        $("#Kenya").show();
